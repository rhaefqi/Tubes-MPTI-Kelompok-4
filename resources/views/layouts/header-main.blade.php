    ...
    <div
        ...
        <div class="lg:flex gap-24 hidden">
            <ul class="menu menu-horizontal flex gap-5 place-items-center justify-between">
                ...
                <li><a href="{{ route('landing.page') }}#layanan" class="text-lg font-bold text-[#006316]">Layanan</a></li>
                <li><a href="{{ route('landing.page') }}#tentang" class="text-lg font-bold text-[#006316]">Tentang </a></li>
