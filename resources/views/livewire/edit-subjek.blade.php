    ...
    <div class="{{ $this->edit == true ? '' : 'hidden' }}">
        ...
        <div class="bg-white rounded-md m-auto fixed inset-0 max-w-lg max-h-fit border-2 border-primary">
            ...
            <div class="font-open mt-4 flex flex-col">
                <form wire:submit.prevent="updateSubjek" class="">
                    <div class="w-full mb-5 px-10">
                        <label for="subjek" class="text-base text-primary font-bold">Subjek Buku</label>
                        <input autocomplete="off" wire:model.live="subjek" type="text" id="subjek" name="subjek"
