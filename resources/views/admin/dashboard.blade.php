...
<body class="flex">
    <!-- Sidebar -->
    <aside id="sidebar" class="transition-all duration-500 sm:flex bg-[#245237] w-56 h-screen sticky left-0 top-0 justify-center text-white font-open">
    </aside>

    <div class="grid-cols-3 w-full flex-grow transition-all duration-500 ease-in-out p-4 flex flex-col">
        <!-- bagian main -->
        <div class="bg-white w-full flex border-b-[3px] border-[#245237] transition-all duration-500 ease-in-out">
        ...
        <div class="text-left text-black font-sans font-extrabold text-4xl mb-1 mt-3">Dashboard Administrator</div>
        ...
        <div class="grid-cols-2 flex flex-col justify-between w-1/3 h-52 rounded-lg my-7 shadow-2xl border-[#245237] border-2 bg-white relative">
            ...
            <div class="pl-3 mt-auto h-9 bg-[#245237] border-[#245237] flex items-center ml-0 rounded-b-sm">
                <a href="#" class="flex text-lg font-bold text-white relative overflow-hidden group">
                    More Info
                    <span class="absolute w-full h-0.5 bg-[#245237] bottom-0 left-0 transition-all duration-300 ease-in-out group-hover:bg-white"></span>
                </a>
            </div>            
        </div>
        ...
        <div class="grid-cols-2 flex flex-col justify-between w-1/3 h-52 rounded-md my-7 shadow-2xl border-[#245237] border-2 bg-white relative">
            ...
            <div class="absolute top-7 right-3  ">
                <svg width="117" height="135" fill="#245237" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="people"><g>
                    <path d="M9 11a4 4 0 1 0-4-4 4 4 0 0 0 4 4zm8 2a3 3 0 1 0-3-3 3 3 0 0 0 3 3zm4 7a1 1 0 0 0 1-1 5 5 0 0 0-8.06-3.95A7 7 0 0 0 2 20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1"></path></g>
                    </svg>
            </div>
            <div class="pl-3 mt-auto h-9 bg-[#245237] border-[#245237] flex items-center ml-0 rounded-b-sm">
                <a href="#" class="flex text-lg font-bold text-white relative overflow-hidden group">
        ...
        <!-- <div class="grid-cols-2 flex flex-col justify-between w-2/3 h-full rounded-md my-1 shadow-2xl border-[#245237] border-2 bg-white relative">
            <div class="text-[#245237] text-left text-3xl font-extrabold ml-3 mt-9">
                <p class="text-2xl font-bold items-center justify-center my-7">Statistik Kunjungan <br>Perpustakaan</p>
            </div>
            <div class="pl-3 mt-auto h-9 bg-[#245237] flex items-center ml-0 rounded-b-sm">
                <span class="flex text-lg font-bold text-white">More Info</span>
            </div>
        </div> -->
