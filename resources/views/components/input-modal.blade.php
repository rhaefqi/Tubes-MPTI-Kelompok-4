...
class="fixed z-50 inset-0">
    ...
    <div class="bg-white rounded-md m-auto fixed inset-0 max-h-fit border-2 border-primary {{ $title === 'Tambah Data User' || $title === 'Tambah Data Petugas' ? 'max-w-max' : 'max-w-lg' }}">
